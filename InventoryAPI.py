...
class InventoryAPIHandler:
    ...
    def create_user(self, user_data):
        ...
        url = f"{self.base_url}/backendapi/users"
    ...
    def create_vendor(self, vendor_data):
        """Create a new vendor"""
        url = f"{self.base_url}/backendapi/vendors"
        return self._post(url, vendor_data)

    # --------- INVENTORY ITEMS ---------
    def create_inventory_item(self, item_data):
        """Add a new inventory item"""
        url = f"{self.base_url}/backendapi/inventory-items"
    ...
    def get_inventory_item(self, name="default", id=""):
        """Get all inventory items - slack"""
        if name!="default":
            url = f"{self.base_url}/backendapi/inventory-items?name="+name
        else:
            url = f"{self.base_url}/backendapi/inventory-items/?id="+id
        return self._get(url)
    ...
    def create_order(self, order_data):
        """Create a new order"""
        url = f"{self.base_url}/backendapi/orders"
    ...
    def update_order(self, order_id, update_data):
        """Update an order"""
        url = f"{self.base_url}/backendapi/orders/{order_id}"
    ...
    def create_vendor_item(self, vendor_item_data):
        ...
        url = f"{self.base_url}/backendapi/vendor-items"
    ...
    def create_notification(self, notification_data):
        ...
        url = f"{self.base_url}/backendapi/notifications"
    ...
    def get_logs(self):
        ...
        url = f"{self.base_url}/backendapi/logs"
        return self._get(url)

    # --------- INVENTORY USAGE ---------
    def record_inventory_usage(self, usage_data):
        """Record inventory usage"""
        url = f"{self.base_url}/backendapi/inventory-usage"
    ...
    def get_slack_config(self):
        """Get inventory usage logs"""
        url = f"{self.base_url}/backendapi/slack-management"
        return self._get(url)

    def update_slack_config(self, id, update_data):
        """Update an inventory item - slack"""
        url = f"{self.base_url}/backendapi/slack-management/{id}"
        return self._put(url, update_data)
    ...
    def _post(self, url, data):
        # Explicitly set Content-Type header for each request
    ...
    def _put(self, url, data):
        response = requests.put(url, headers=self.headers, json=data)  # Using json parameter
        return self._handle_response(response)
