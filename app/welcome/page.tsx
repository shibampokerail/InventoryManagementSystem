...
//               <p className="font-semibold">admin@truman.edu</p>
//               <p>or call (660) 555-1234</p>
//             </div>
//           </CardContent>
//           <CardFooter className="flex justify-center pt-2 pb-6">
//             <Button onClick={logout} className="bg-purple-700 hover:bg-purple-800 text-white px-8 py-2">
//               Logout
//             </Button>
//           </CardFooter>
//         </Card>
